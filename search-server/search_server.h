...
public:
    ...
    std::set<std::string> GetWordsById(int doc_id) const;
...
private:
    ...
    void IsValidQueryWord(const std::string& word) const;
...
SearchServer::SearchServer(const StringContainer& stop_words)
        ...
        if(!(all_of(stop_words.begin(), stop_words.end(), IsValidWord))){
            throw std::invalid_argument("stop words contain unavailable charactes");
        }
    }
